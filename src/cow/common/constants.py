...
COW_PROTOCOL_SETTLEMENT_CONTRACT_ADDRESS = map_address_to_supported_networks(
    SETTLEMENT_CONTRACT
)
""" An object containing the addresses of the CoW Protocol settlement contracts for each supported chain. """

COW_PROTOCOL_VAULT_RELAYER_ADDRESS = map_address_to_supported_networks(VAULT_RELAYER)
""" An object containing the addresses of the CoW Protocol Vault relayer contracts for each supported chain. """

EXTENSIBLE_FALLBACK_HANDLER_CONTRACT_ADDRESS = map_address_to_supported_networks(
...
COMPOSABLE_COW_CONTRACT_ADDRESS = map_address_to_supported_networks(COMPOSABLE_COW)
